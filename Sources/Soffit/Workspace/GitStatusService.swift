...
/// in the workspace root and exposes a per-file status map. Refreshes on
/// FSEvents nudges and on a 10-second timer (catches `git checkout` etc.
/// that may not always trip FSEvents under all configurations).
@MainActor
